...
export default function About() {
  return (
    <div className="bg-[#F3F3F3] py-12 sm:py-16">
      <div className="container mx-auto px-4 lg:px-8 xl:px-16">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-[28px] sm:text-[36px] lg:text-[44px] font-bold text-gray-900 leading-tight mt-2">
            Elevating Design Standards Since 2023
          </h2>
        </div>

        {/* Content Grid */}
        <div className="mt-10 lg:mt-14 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          {/* Left: Image + Name */}
          <div className="flex flex-col items-center lg:items-start overflow-visible">
            <div className="relative group w-full max-w-[360px] sm:max-w-[460px] lg:w-[580px] aspect-[4/2.5]">
              {/* Bottom Card */}
            ...
            <div className="mt-6 sm:mt-8 text-center lg:text-left">
              <h3 className="text-[26px] sm:text-[32px] font-bold text-gray-900">
                Raju Ahamed
              </h3>
          ...
          <div className="space-y-10 sm:space-y-12">
            <div className="w-full">
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 leading-relaxed">
                Hi, I&apos;m Raju, a passionate UI/UX Designer with over 3 years
                of experience designing engaging and user-friendly interfaces
                for mobile apps and websites. I specialize in creating
                intuitive, interactive, and dynamic user experiences. My design
                philosophy is{" "}
                <span className="font-semibold">
                  &ldquo;Simple is smart&rdquo;
                </span>{" "}
                and I always prioritize creating simple, clean, and
                aesthetically pleasing designs.
              </p>
            </div>

            {/* Experience Timeline */}
            <div className="px-3 sm:px-4 border-l-2 border-gray-300">
              <h3 className="text-[26px] sm:text-[32px] font-bold text-gray-900 mb-6 sm:mb-8">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <p className="text-lg sm:text-[20px] text-gray-500">
                    SM Technology
                  </p>
